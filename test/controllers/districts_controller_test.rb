...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { name: @district.name, place: @district.place, postal_code: @district.postal_code } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { name: @district.name, place: @district.place, postal_code: @district.postal_code } }
